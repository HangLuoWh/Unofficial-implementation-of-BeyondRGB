...
class CustomDataset(Dataset):
    def __init__(self, hyper):
        ...
        print(f"Total number of training samples: {len(self.train_list)}")
    ...
    def __getitem__(self, idx):
        ...
        # Randomly crop the multispectral image, extract triplets, compute log-chroma histograms, and compute triplet cost maps
...
class CustomValDataset(Dataset):
    def __init__(self, hyper):
        ...
        print(f"Total number of validation samples: {len(self.val_list)}")
    ...
    def __getitem__(self, idx):
        ...
        # Center crop the multispectral image, extract triplets, compute log-chroma histograms, and compute triplet cost maps
